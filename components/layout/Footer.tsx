...
export default function Footer() {
  return (
    <footer className="glass-edge border-t border-white/[0.04] bg-ink-900">
      <div className="container-site grid gap-10 py-14 sm:grid-cols-2 lg:grid-cols-3">
        {/* Marque */}
        <div>
          <p className="font-display text-xl text-ivory-50">{company.name}</p>
          ...
          <ul className="mt-4 space-y-2.5 text-sm">
            {[
              ...
              <li key={href}>
                <a
                  href={href}
                  className="text-ivory-200/70 transition-colors hover:text-brass-400"
                >
                  {label}
                </a>
              </li>
        ...
        <div>
          ...
          <ul className="mt-4 space-y-3 text-sm text-ivory-200/70">
            <li>
              <a
                href={`tel:+${company.phoneRaw}`}
                className="flex items-center gap-2.5 transition-colors hover:text-brass-400"
              >
                <PhoneIcon className="h-4 w-4 shrink-0 text-brass-500" />
            ...
            <li>
              <a
                ...
                className="flex items-center gap-2.5 transition-colors hover:text-brass-400"
              >
                <WhatsAppIcon className="h-4 w-4 shrink-0 text-brass-500" />
                WhatsApp
              </a>
            </li>
            <li>
              <a
                ...
                className="flex items-center gap-2.5 transition-colors hover:text-brass-400"
              >
                <MailIcon className="h-4 w-4 shrink-0 text-brass-500" />
                {company.email}
              </a>
            </li>
