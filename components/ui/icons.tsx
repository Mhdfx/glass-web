/**
 * Icônes SVG inline — trait 1.5, style linéaire cohérent (inspiré Lucide).
 * Pas d'emoji, pas de dépendance externe.
 */
...
/* ————— Piliers « Pourquoi nous » ————— */

export function HandCraftIcon({ className = "h-7 w-7" }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className={className} aria-hidden="true">
      <path d="M12 3v2" />
      ...
      <path d="M21 12h-2" />
      <path d="M8.5 12a3.5 3.5 0 1 1 7 0c0 1.5-.7 2.5-1.5 3.5-.6.8-1 1.6-1 2.5h-2c0-.9-.4-1.7-1-2.5-.8-1-1.5-2-1.5-3.5Z" />
      <path d="M10 20h4" />
    </svg>
  );
}
...
export function RulerIcon({ className = "h-7 w-7" }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className={className} aria-hidden="true">
      <path d="M21.3 8.7 15.3 2.7a2.4 2.4 0 0 0-3.4 0l-9.2 9.2a2.4 2.4 0 0 0 0 3.4l6 6a2.4 2.4 0 0 0 3.4 0l9.2-9.2a2.4 2.4 0 0 0 0-3.4Z" />
